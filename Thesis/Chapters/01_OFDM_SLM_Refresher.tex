...
Because the time-domain OFDM signal --- the sum of $N$ independently modulated
complex exponentials --- can occasionally see all subcarrier contributions align
constructively, large amplitude peaks appear.  The severity of this peaking is
quantified by the
