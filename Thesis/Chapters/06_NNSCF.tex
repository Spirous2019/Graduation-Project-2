...
\subsection{The Scaling Coefficient}

The key innovation of the SCF technique lies in the frequency-domain reconstruction. By modeling the iterative convergence of ICF, Wang and Tellambura~\cite{wang2005simplified} derived a closed-form scaling coefficient $\bar{\beta}$ to scale the filtered clipping noise $\tilde{F}_k$ before subtraction. The final SCF output in the frequency domain is expressed as:
\begin{equation*}
